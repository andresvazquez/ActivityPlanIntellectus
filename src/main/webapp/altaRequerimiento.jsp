...
<body>
    ...
    <form action="AltaRequerimientoController" method="post">
        ...
        <label for="folio">Folio (5 dígitos númericos): </label>
        <input type="text" name="folio" pattern="\d{5}" title="Debe ingresar cinco dígitos numéricos"  maxlength="5" required>
        <br>
